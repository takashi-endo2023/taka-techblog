...
published: false
published_at: "2023-10-25 09:00"
canonical_url: "https://www.taka-techblog.com/blog/javascript-dev-tools-eslint-jest"
---

:::message
この記事は [taka-techblog](https://www.taka-techblog.com/blog/javascript-dev-tools-eslint-jest?utm_source=zenn&utm_medium=referral) にも掲載しています。
:::
...
「改訂3版JavaScript本格入門」ではツールの使い方だけでなく、なぜそのツールが必要なのかという背景も含めて整理されている。開発環境の「なぜ」を理解したい人に特に役立つ。Jestを導入してテストを書き始めると、次に直面するのは「何をどこまでテストするか」という戦略の問題だ——[フロントエンドのテスト戦略——「全部書く」をやめてから品質が上がった話](/blog/frontend-testing-practical-approach)でその考え方を整理している。
