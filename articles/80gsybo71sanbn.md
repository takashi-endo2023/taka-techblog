...
published: false
published_at: "2026-07-19 09:00"
canonical_url: "https://www.taka-techblog.com/blog/system-audit-experience"
---

:::message
この記事は [taka-techblog](https://www.taka-techblog.com/blog/system-audit-experience?utm_source=zenn&utm_medium=referral) にも掲載しています。
:::
...
監査で問われたリリースフローの設計経緯については、[引き継いだリリースフローが、監査で初めて意味を持った](/blog/release-flow-regulated-industry)に詳しく書いている。

なお、これはスポンサー（製薬会社）からの監査の話だが、委託先のCRO品質組織から受ける監査はまた観点が違う。その実体験は[「記録を見せろ」と「機密だから見せられない」の攻防——CRO品質監査に技術者として対応した話](/blog/cro-audit-tech-response)にまとめた。
