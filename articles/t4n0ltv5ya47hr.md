...
published: true
published_at: "2026-11-03 09:00"
canonical_url: "https://www.taka-techblog.com/blog/github-actions-oidc-aws"
---

:::message
この記事は [taka-techblog](https://www.taka-techblog.com/blog/github-actions-oidc-aws?utm_source=zenn&utm_medium=referral) にも掲載しています。
:::
...
**実装例**: この記事のOIDC設定を使った実際のデプロイ構成は[ポートフォリオの年収トラッカー](/portfolios)で紹介しています。

OIDCによるキーレスデプロイを含むCI/CD全体の構成については、[GitHub Actions + AWSでCI-CDを構築する——OIDCでアクセスキーなしの安全なデプロイ](/blog/aws-devops-github-actions)でより広い視点からまとめています。
