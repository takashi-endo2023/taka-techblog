...
ロードアベレージの読み方を押さえたら、次はプロセス管理・ログ監視・パーミッションなど、サーバ運用で日常的に必要になる操作全体を整理しておきたい。[Linux運用で最低限知るべきこと——ターミナル作業を怖くなくするための基礎知識](/blog/linux-server-operations-basics)が体系的な入口になる。
