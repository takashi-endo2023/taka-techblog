...
topics: ["Web","バックエンド"]
published: false
published_at: "2024-01-08 09:00"
canonical_url: "https://www.taka-techblog.com/blog/http-methods-status-codes"
---

:::message
この記事は [taka-techblog](https://www.taka-techblog.com/blog/http-methods-status-codes?utm_source=zenn&utm_medium=referral) にも掲載しています。
:::
...
フロントエンドエンジニアがバックエンドやAPI設計に関わる機会が増えた現代では、HTTPの仕様を正確に理解しておくことは基礎教養のひとつだと思っている。HTTPを理解した次は、URLの設計原則を押さえておくと実務での判断が具体的になる——[望ましいURIとは何か——Webを支える技術で学んだURL設計のベストプラクティス](/blog/uri-design-best-practices)にそのまとめがある。
