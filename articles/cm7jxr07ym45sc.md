...
canonical_url: "https://www.taka-techblog.com/blog/javascript-array-methods"
---

:::message
この記事は [taka-techblog](https://www.taka-techblog.com/blog/javascript-array-methods?utm_source=zenn&utm_medium=referral) にも掲載しています。
:::
...
「改訂3版JavaScript本格入門」では配列メソッドだけでなく、クロージャや非同期処理など、実務でよく使うJavaScriptの仕組みが体系的に整理されている。「なんとなく動く」から「なぜ動くかわかる」レベルに上げたい人に特におすすめだ。関数型スタイルで書けるようになった次のステップとして、クラスとモジュールを理解するとTypeScriptでの設計の幅が広がる——[JavaScriptのクラスとモジュールを理解する——TypeScriptに活きるOOPの基礎](/blog/javascript-class-module)で整理している。
