...
emoji: "🔧"
type: "tech"
topics: ["AWS","インフラ","ネットワーク"]
published: false
published_at: "2024-08-06 09:00"
canonical_url: "https://www.taka-techblog.com/blog/aws-vpc-subnet-design"
---

:::message
この記事は [taka-techblog](https://www.taka-techblog.com/blog/aws-vpc-subnet-design?utm_source=zenn&utm_medium=referral) にも掲載しています。
:::
...
ネットワーク設計と合わせて整備したいのがIAMだ。各サブネットのリソースに付与するロールや最小権限の設計については[AWSのIAM設計を正しく理解する——最小権限の原則と実務での落とし穴](/blog/aws-iam-least-privilege)で詳しく解説している。
