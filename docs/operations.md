...
- [ ] Zenn: #3「mainブランチを捨てた」を公開（`articles/4yshjgf1hghg6y.md` の `published: false → true`）
- [ ] X: 一言投稿（記事URLなし・アカウントに動きを出す）

```
30歳で会社員からエンジニアに転身して10年。
テックリードになって気づいたのは、
技術力より「技術を言語化する力」の方が
圧倒的に評価されるということ。
```
...
| 日付 | アクション | 内容 |
|------|-----------|------|
| 5/26 月 | **X 記事告知** | #6「AIがなかったら死んでた」|
| 5/28 水 | **X 一言** | 下記ストックから1本 |
| 5/29 木 | Zenn公開 + **X 記事告知** | #4「AIを社内に広めたら」|
...
| 日付 | アクション | 内容 |
|------|-----------|------|
| 6/1 日 | Zenn公開 | #5「外部ベンダーから内製化した3年間」|
| 6/2 月 | **X 記事告知** | #5「内製化3年間」|
| 6/4 水 | **X 一言** | 下記ストックから1本 |
| 6/5 木 | **X 記事告知** | #7「仮面テックリード」|
| 6/7 土 | **X 一言** | 下記ストックから1本 |

**6/2 X投稿文（コピペ用）**
```
年間480万円の外部委託費を3年かけてゼロにした。

内製化は「安くなる」という話ではなく、
「自分たちでコントロールできるようになる」話だった。

その過程で起きたこと全部書きました →
https://www.taka-techblog.com/blog/naisei-kansei
