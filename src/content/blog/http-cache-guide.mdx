...
description: "Cache-ControlディレクティブとETag・Last-Modifiedによる条件付きGET、CDNキャッシュ設計まで。HTTPキャッシュの仕組みを根本から理解して実務のパフォーマンス改善に活かす。"
pubDate: "2024-03-13"
tags: ["インフラ", "アーキテクチャ", "パフォーマンス"]
zennHash: "721c49e186f713"
zennEmoji: "⚡"
zennType: "tech"
zennTopics: ["HTTP","パフォーマンス","nextjs"]
---
