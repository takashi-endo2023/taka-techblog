...
本で体系をつかんだら、次は手を動かす番だ。動画で進めたいなら<a href="https://trk.udemy.com/Pz44mq" target="_blank" rel="nofollow sponsored noopener">Udemy</a>のJavaScript講座も選択肢になる。読む・書く・見るを併用すると理解の定着が早い。セール時（1,200円〜）が狙い目。
