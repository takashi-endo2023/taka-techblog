...
description: "Next.jsアプリのデプロイ先としてVercel、AWS（S3+CloudFront、Amplify、EC2）、Herokuを比較。SSG・SSR・ISRの特性も踏まえ、プロジェクト規模・要件ごとの選択基準を実務経験から整理する。"
pubDate: "2024-11-13"
tags: ["Next.js", "AWS", "DevOps"]
zennHash: "103c1c4d7b0a43"
zennEmoji: "🚀"
zennType: "tech"
zennTopics: ["nextjs","AWS","DevOps"]
---
